...
public class FragmentGoogleMap extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback, OnMapReadyCallback {
    private final int CODE_DEMANDE_LOCALISATION = 1;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            throw new RuntimeException(context.toString() + " doit implémenter OnFragmentInteractionListener");
        }
    }
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(getContext(), permissions[0]) == PackageManager.PERMISSION_GRANTED || ActivityCompat.checkSelfPermission(getContext(), permissions[1]) == PackageManager.PERMISSION_GRANTED) {
            ...
            requestPermissions(permissions, CODE_DEMANDE_LOCALISATION);
        }
...
//                        .commit();
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == CODE_DEMANDE_LOCALISATION) {
     ...
     */
    private void ajouterPinRestaurant(List<Object> listeRestaurant) {
